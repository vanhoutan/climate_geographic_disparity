...
for (t in 2000:2017) {
  ...
  d1 <- stack(paste0('~/Desktop/climate/data/CO2/ODIAC/1deg_ncdf/odiac2018_1x1d_',t , '.nc'), varname = "land")
  d2 <- stack(paste0('~/Desktop/climate/data/CO2/ODIAC/1deg_ncdf/odiac2018_1x1d_',t , '.nc'), varname = "intl_bunker")
...
load("~/clim_geo_disp/output/ODIAC_CO2_MERRA_BC_Match_Up_2000-2017.RData")
...
load("/Users/ktanaka/clim_geo_disp/output/MERRA2_BC_2000-2017_Stacked.RData")
