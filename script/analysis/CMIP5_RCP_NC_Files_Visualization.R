...
names(rcp_anom) = c("RCP4.5_anomaly_(2006-2055)-(1956-2005)", 
                    "RCP4.5_anomaly_(2050-2099)-(1956-2005)",
                    "RCP8.5_anomaly_(2006-2055)-(1956-2005)",
                    "RCP8.5_anomaly_(2050-2099)-(1956-2005)")
...
names(rcp_ensem_mean_chang) = c("RCP4.5_ensem_mean_change_(2006-2055)-(1956-2005)", 
                                "RCP4.5_ensem_mean_change_(2050-2099)-(1956-2005)",
                                "RCP8.5_ensem_mean_change_(2006-2055)-(1956-2005)",
                                "RCP8.5_ensem_mean_change_(2050-2099)-(1956-2005)")

rcp_ensem_stdanom = stack(rcp45_ensem_stdanom_1, rcp45_ensem_stdanom_2,
                          rcp85_ensem_stdanom_1, rcp85_ensem_stdanom_2)

names(rcp_ensem_stdanom) = c("RCP4.5_ensem_stdanom_(2006-2055)-(1956-2005)", 
                                "RCP4.5_ensem_stdanom_(2050-2099)-(1956-2005)",
                                "RCP8.5_ensem_stdanom_(2006-2055)-(1956-2005)",
                                "RCP8.5_ensem_stdanom_(2050-2099)-(1956-2005)")
...
names(rcp_historical_stdanom) = c("RCP4.5_historical_stdanom_(2006-2055)-(1956-2005)", 
                                "RCP4.5_historical_stdanom_(2050-2099)-(1956-2005)",
                                "RCP8.5_historical_stdanom_(2006-2055)-(1956-2005)",
                                "RCP8.5_historical_stdanom_(2050-2099)-(1956-2005)")
