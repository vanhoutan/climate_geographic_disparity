...
setwd("~/Desktop/Eclipse V5a/ECLIPSE_V5a_baseline_CLE")
df <- stack('ECLIPSE_base_CLE_V5a_BC.nc') #%>% rotate()

png("Eclipse_V5a_Baseline_BCE_1990-2050.png", res = 500, height = 10, width = 10, units = "in")
...
plot(log10(diff), col = change(100), zlim = c(-8,0), main = "Future-historic difference log10(Kt/year)"); map(add = T)
